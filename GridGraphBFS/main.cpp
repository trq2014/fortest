...
int main(int argc, char ** argv) {
    ...
    long memory_bytes;
    if (argc<3) {
        path = "/home/gxl/forTest/LiveJournal/grid";
        start_vid = 0;
        memory_bytes = 8l*1024l*1024l*1024l;
    } else {
        path = argv[1];
        start_vid = atoi(argv[2]);
        memory_bytes = (argc>=4)?atol(argv[3])*1024l*1024l*1024l:8l*1024l*1024l*1024l;
    }
